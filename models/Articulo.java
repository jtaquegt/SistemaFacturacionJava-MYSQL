...
public class Articulo {
    ...
    public Articulo(int idArticulo, String codigo, int idProveedor, String nombre, String descripcion, int cantidad, double precio) {
        this(codigo, idProveedor, nombre, descripcion, cantidad, precio); // reutiliza constructor anterior
    ...
    public void setCantidad(final int cantidad) { this.cantidad = cantidad; }

    public double getPrecio() { return precio; }
    public void setPrecio(final double precio) { this.precio = precio; }
